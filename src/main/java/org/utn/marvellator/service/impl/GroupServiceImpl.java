...
public class GroupServiceImpl implements GroupService {
    ...
    public List<MarvelCharacter> getIntersectionCharacters(Group g1, Group g2) {
        ...
        List<MarvelCharacter> g2Characters = g2.getCharacters();
			List<MarvelCharacter> finalList = new ArrayList<>();
				for (MarvelCharacter c1 : g1Characters){
					for (MarvelCharacter c2 : g2Characters){
						if (c1.getMarvelId().equals(c2.getMarvelId())){
							finalList.add(c1);
						}
					}
				}
