...
public class GroupServiceTest {
    ...
    public void getIntersectionCharacters_with2groupsWithCharacters_shouldReturnCharactersInBothGroups() throws CharacterAlreadyInGroupException {
        ...
        MarvelCharacter char1 =  new MarvelCharacter("char_1", "1");
        MarvelCharacter char2 =  new MarvelCharacter("char_2", "2");
        MarvelCharacter char3 =  new MarvelCharacter("char_3", "3");
        MarvelCharacter char4 =  new MarvelCharacter("char_4", "4");
        MarvelCharacter char5 =  new MarvelCharacter("char_5", "5");
